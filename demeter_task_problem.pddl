...
(define (problem demeter-1)
    ...
    (:init
        ...
        (demeter demeter1) (demeter demeter2) ; create demeter
        (empty demeter1) (empty demeter2); demeter start without data
        (at demeter1 cable_start) (at demeter2 cable_start); demeter start at cable start
        (= (battery-amount demeter1) 10) (= (battery-amount demeter2) 10) ; initial battery
        (= (recharge-rate demeter1) 1) (= (recharge-rate demeter2) 1) ; recharge rate
