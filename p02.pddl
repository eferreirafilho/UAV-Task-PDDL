...
(define (problem demeter-1)
    ...
    (:init
        ...
        (= (battery-amount vehicle1) 50) (= (battery-amount vehicle2) 50) ; initial battery
    ...
    (:goal
        (and
            ...
            (at vehicle1 cable_start) (at vehicle2 cable_start); vehicle has to finish in the surface
            (= (battery-amount vehicle1) 100) (= (battery-amount vehicle2) 100); Finish with full battery
        )
    )
